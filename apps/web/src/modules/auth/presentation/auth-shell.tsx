	...
	return (
		<div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 relative overflow-hidden">
			...
			<motion.div
				...
				className="relative z-10 w-full max-w-100 space-y-8"
			>
				...
				<div className="group/shell relative bg-[#0d0d0f]/80 border border-white/5 p-8 rounded-sm shadow-2xl overflow-hidden transition-colors hover:border-hextech-cyan/20">
					{children}
					<div className="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-hextech-cyan/50 to-transparent transform scale-x-0 group-hover/shell:scale-x-100 transition-transform duration-1000" />
				</div>
