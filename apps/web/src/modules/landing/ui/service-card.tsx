...
export function ServiceCard({ index, service }: ServiceCardProps) {
	...
	return (
		<Link href="/start">
			<div className="service-card flex-shrink-0 w-[80vw] md:w-[28vw] aspect-[16/11] group relative p-8 bg-surface-muted border border-white/5 hover:border-hextech-cyan/40 transition-colors duration-500 rounded-sm flex flex-col justify-end overflow-hidden cursor-pointer shadow-2xl">
