...
const BoosterDashboardError = ({ reset }: { reset: () => void }) => {
	return (
		<div className="flex min-h-[55vh] items-center justify-center px-6">
			<div className="w-full max-w-md rounded-sm border border-white/10 bg-white/[0.03] p-8 text-center">
				<p className="text-xs font-black uppercase tracking-[0.22em] text-white">
					Não foi possível carregar o portal do booster.
				</p>
				<p className="mt-3 text-xs leading-6 text-white/50">
					Atualize a sessão ou tente novamente. Se a sessão expirou, o acesso
					será enviado para login automaticamente.
				</p>
...
export default BoosterDashboardError;
